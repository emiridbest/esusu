    ...
    return (
        <div className="flex h-full">
            ...
            <div className="hidden md:block w-[260px] h-full border-r border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900 overflow-y-auto">
                <div className="p-4">
                    <Button
                        className="w-full mb-4 gap-2 bg-purple-600 hover:bg-purple-700 text-white"
                ...
                <div className="shrink-0 border-t dark:border-gray-800 bg-white dark:bg-gray-950 p-4">
                    ...
                    >
                        <div className="relative">
                            <Input
                                className="pr-12 py-6 pl-4 bg-white dark:bg-gray-900 border-2 dark:border-gray-700 rounded-xl"
                            ...
                            <Button
                                ...
                                size="icon"
                                className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-purple-600 hover:bg-purple-700 text-white rounded-lg h-9 w-9"
                            >
