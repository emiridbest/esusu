...
const COUNTRIES: Record<string, CountryData> = {
  ...
  ng: {
    ...
    servicesAvailable: { electricity: true, data: true, cable: true },
    phoneCode: "+234",
    tier: 1
  },
  gh: {
    ...
    servicesAvailable: { electricity: true, data: true, cable: false },
    phoneCode: "+233",
    tier: 1
  },
  ke: {
  ...
  jm: {
    ...
    servicesAvailable: { electricity: false, data: true, cable: false },
    phoneCode: "+1876",
    tier: 2
  },
  ht: {
