...
export async function GET(request: NextRequest) {
    ...
    try {
        ...
        console.log(`Farcaster API: Fetching electricity providers for country: ${sanitizedCountry}`);
        ...
        console.log(`Farcaster API: Mapped ${sanitizedCountry} to ${isoCountryCode}`);
        
        // Use electricityPaymentService like the frontend does
