...
const mcpDescriptor = {
  ...
  tools: [
    {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          usdtAddress: {
            type: "string",
            description: "USDT token contract address on Celo",
            default: "0x48065fbBE25f71C9282ddf5e1cD6D6A887483D5e",
          },
        },
        required: ["recipient"],
      },
    },
    {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          celoAddress: {
            type: "string",
            description: "CELO token address on Celo",
    ...
    },
    {
      ...
      inputSchema: {
        ...
        properties: {
          userAddress: {
            type: "string",
            description: "The user's wallet address to whitelist",
          },
        },
      ...
      inputSchema: {
        ...
        properties: {
          tokenAddress: {
            type: "string",
            description:
              "Optional specific token address. Omit to get both CELO and USDT balances.",
          },
        },
      },
    },
    ...
    },
    {
      ...
      inputSchema: {
        ...
        properties: {
          name: {
            type: "string",
            description: "Name for the thrift group",
          },
        },
        required: ["name"],
      },
    },
    {
      ...
      inputSchema: {
        ...
        properties: {
          groupId: {
            type: "string",
            description: "The thrift group ID to join",
          },
        },
        required: ["groupId"],
      },
  ...
  resources: [
    {
      name: "esusu_smart_contracts",
      description: "Esusu protocol smart contracts on Celo",
    },
    {
      name: "faucet_contract",
      description: "Esusu faucet contract for gas subsidies",
    },
    {
      name: "thrift_contract",
      description: "Thrift (rotational savings) contract",
    },
    {
      name: "yield_vault_contract",
      description: "Yield vault contract for savings",
    },
    {
      name: "celo_network_config",
      description: "Celo blockchain network configuration",
    },
  ],
};

export async function GET() {
  return NextResponse.json(mcpDescriptor, {
    headers: {
