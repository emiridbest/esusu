...
const mcpDescriptor = {
  name: "Esusu AI",
  version: "2025-06-18",
  description: "Autonomous onchain financial execution agent for the Esusu decentralized savings protocol on Celo. Handles faucet claims, savings deposits/withdrawals, yield operations, and thrift (rotational savings) group management.",
  tools: TOOLS,
  prompts: [],
  resources: RESOURCES,
};
