...
return (
    <div className="flex flex-col items-center p-6 min-h-screen bg-gradient-to-br from-slate-50 via-amber-50/30 to-yellow-50/20 dark:from-slate-900 dark:via-slate-800 dark:to-amber-900/20">
      <div className="max-w-xl w-full flex flex-col items-center">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-3xl font-bold bg-gradient-to-r from-slate-800 via-amber-700 to-yellow-700 dark:from-slate-200 dark:via-amber-300 dark:to-yellow-300 bg-clip-text text-transparent mb-2">
        ...
        <Card className="w-full bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm border border-amber-200/50 dark:border-amber-700/30 shadow-xl shadow-amber-500/10 dark:shadow-amber-500/20">
          <CardContent className="pt-6">
            {isConnected && loadingWhitelist ? (
              <div className="flex flex-col items-center justify-center my-8 p-6 bg-gradient-to-br from-amber-50 to-yellow-50/50 dark:from-amber-900/20 dark:to-yellow-900/10 rounded-lg border border-amber-200/30 dark:border-amber-700/20">
                ...
                <p className="text-slate-700 dark:text-slate-300 font-medium">Verifying your status...</p>
              </div>
            ) : null}
            ...
            {isConnected &&
              ...
              (isVerified || isWhitelisted) && (
                <div className="flex flex-col items-center p-6">
                  <div className="w-full bg-gradient-to-br from-emerald-50 to-green-50 dark:from-emerald-900/30 dark:to-green-900/20 rounded-xl border border-emerald-200/50 dark:border-emerald-700/30 p-6 mb-6">
                    <IdentityCard />
                  </div>
                  <div className="flex items-center gap-3 p-4 bg-gradient-to-r from-emerald-100 to-green-100 dark:from-emerald-900/40 dark:to-green-900/30 rounded-lg border border-emerald-300/50 dark:border-emerald-600/30">
              ...
              <div className="flex flex-col items-center gap-6 p-6">
                <div className="w-full bg-gradient-to-br from-amber-50 to-yellow-50/50 dark:from-amber-900/20 dark:to-yellow-900/10 rounded-xl border border-amber-200/50 dark:border-amber-700/30 p-6">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-slate-800 dark:text-slate-200">Identity Verification Required</h3>
                      <p className="text-slate-600 dark:text-slate-400">Complete verification to access all features</p>
                    </div>
                  </div>
                ...
                <div className="flex items-start gap-3 p-4 bg-slate-50 dark:bg-slate-700/50 rounded-lg border border-slate-200 dark:border-slate-600/30">
        ...
        <div className="mt-6 w-full">
          <div className="bg-gradient-to-r from-slate-100/80 to-amber-50/40 dark:from-slate-800/50 dark:to-amber-900/20 rounded-lg border border-slate-200/50 dark:border-slate-600/30 backdrop-blur-sm">
            <HelpSection />
          </div>
        </div>
      </div>
