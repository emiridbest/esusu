...
import { UsersIcon, CalendarIcon, BellIcon, PlusIcon } from 'lucide-react';
    ...
    <ThriftProvider>
      <div className="container mx-auto px-4 pt-10 pb-20">
        ...
        >
          ...
          >
            <h2 className="text-2xl font-bold mb-4 text-left">Available Thrift Groups</h2>
            <CampaignList />
          </motion.div>
            ...
            <Card className="bg-white/50 dark:bg-gray-800/50 backdrop-blur-md border-primary/20 border max-w-3xl mx-auto">
              <CardContent className="pt-6">
                <div className="bg-primary/5 -mt-6 -mx-6 px-6 py-4 rounded-t-lg border-b border-primary/10 mb-6">
                  <h3 className="font-medium text-lg text-gray-900 dark:text-white">How It Works</h3>
                </div>
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-400">Trustless operation with blockchain-powered smart contracts on Celo</p>
                    </div>
                  </div>
              ...
              <CardFooter className="border-t border-gray-100 dark:border-gray-700 flex justify-center">
                <div className="flex mt-2 items-center text-gray-500 dark:text-gray-400 text-sm">
