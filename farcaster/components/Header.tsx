                          ...
                          <DropdownMenuGroup>
                            {aboutMenuItems.map((item) => (
                              <DropdownMenuItem
                                key={item.title}
                                className={cn(
                                  "cursor-pointer hover:bg-primary/10 text-black/90 dark:text-white/80 hover:text-primary focus:bg-primary/10 focus:text-primary",
                  ...
                  <SheetContent>
                    <div className="flex flex-col space-y-4 mt-8">
                      ...
                      <div className="border-t pt-4">
                        <h3 className="font-medium text-sm text-gray-500 mb-2">About Us</h3>
                        {aboutMenuItems.map((item) => (
                          <Link
                            key={item.title}
                            href={item.href}
                            className={cn(
                              "block py-2 text-sm transition-colors hover:text-primary text-gray-700 dark:text-gray-300",
